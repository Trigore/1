...
function FUNC_DRINK( ply, id, client, icon )
	...
	ply:Notice( "-3 Intoxication", GAMEMODE.Colors.Green )
...
function FUNC_OPENBOX( ply, id )
	...
	local tbl = { ITEM_SUPPLY, ITEM_AMMO, ITEM_MISC, ITEM_WPN_COMMON, ITEM_WPN_SPECIAL }
	local chancetbl = { 0.60,     0.20,     0.50,           0.05,           0.03 }
...
item.Register( { 
	Name = "Water", 
	Description = "Restores 25 stamina and cures hangovers.",
	Stackable = true, 
	Type = ITEM_MISC,
	Weight = 0.15, 
	Price = 3,
